...
Route::middleware('auth.jwt')->group(function () {
    ...
    Route::middleware('module.permission:user_management')->group(function () {
    ...
    Route::prefix('roles')->name('roles.')->group(function () {
        ...
        Route::get('modules', [RoleController::class, 'modules'])->name('modules');
    ...
    Route::middleware('module.permission:catalog')->group(function () {
    ...
    Route::prefix('transactions')->name('transactions.')->middleware('module.permission:sales')->group(function () {
